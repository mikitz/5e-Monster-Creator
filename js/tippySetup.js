...
function iGotThisTippy(){
    ...
    if (selectedMethod == 'Pre_Gens') { addTippy('points-info', '<b><u>Points</u></b><br> Points = CR * 5 + 8 <br> Use these points to purchase the below items and see the changes reflected in the statblock to the left.') }
    else { addTippy('points-info', '<b><u>Points</u></b><br> Points = CR * 5 + 6 <br> Use these points to purchase the below items and see the changes reflected in the statblock to the left.') }
